...
model = dict(
    ...
    backbone=dict(
        ...
        frozen_stages=1,
        style='pytorch',
        dcn=dict(type='DCN', groups=64, deformable_groups=1, fallback_on_stride=False),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='data/train/annotations/train_nn.json',
        img_prefix=data_root + 'train/image/',
        pipeline=train_pipeline),
    test=dict(
        type=dataset_type,
        ann_file='data/train/annotations/testB_noww.json',
...
work_dir = './work_dirs/cas_x101_64x4d_fpn_htc_1x/'+exp_time
