...
underwater_classes = ['holothurian', 'echinus', 'scallop', 'starfish', 'waterweeds']
def parse_args():
...
if __name__ == '__main__':
    args = parse_args()
    test_json_raw = json.load(open("data/train/annotations/testB_withww.json", "r"))
    test_json = json.load(open("testB_results/" + args.test_json, "r"))
    submit_file_name = args.submit_file
    submit_path = 'testB_submit/'
